...
public class AddMemoryMusicActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_memory_music);
...
//        }
    ...
    public void upload() {
        ...
        Intent intent = new Intent(AddMemoryMusicActivity.this, MainActivity.class);
