...
public class RecommendFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    class StoreDataThread extends Thread{
        ...
        public void run() {
            ...
            //DeletePreviousData
            sqLiteDatabase.delete("Page3","account=?",new String[]{userAccount});
            ...
            for(int i=0;i<Cards.size();++i)
            {
                ...
                sqLiteDatabase.insert("Page3",null,values);
                values.clear();
            }
    ...
    private void restoreData() {
        ...
        Cursor cursor=sqLiteDatabase.query("Page3",null,"account=?",new String[]{userAccount},null,null,null);
